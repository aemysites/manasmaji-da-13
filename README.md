...
## Environments
- Preview: https://main--manasmaji-da-13--aemysites.aem.page/
- Live: https://main--manasmaji-da-13--aemysites.aem.live/
...
1. Open the `manasmaji-da-13` directory in your favorite IDE and start coding :)
